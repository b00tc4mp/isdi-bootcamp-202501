  ...
  .then(() => {
    ...
    .then(hash=>{
      return users.insertMany([
        {name:'Diego Maradona', email: 'diego@maradona.com', password: hash},
        {name: 'Lionel Messi', email: 'lio@messi.com', password: hash},
        {name: 'Angel di Maria', email: 'angel@dimaria.com', password: hash}
