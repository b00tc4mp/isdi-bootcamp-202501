        ...
        <div className="fixed inset-0 flex items-center justify-center bg-white/30 backdrop-brightness-50 z-50">
            <div className="bg-white rounded-2xl shadow-lg p-6 w-full max-w-sm mx-4">
                ...
                <div className="flex justify-center space-x-6">
                    <button type="button" onClick={handleCancelClick} className="cursor-pointer px-6 py-2 bg-orange-500 text-white rounded-lg hover:bg-orange-600 transition-colors focus:outline-none focus:ring-2 focus:ring-orange-300">Cancel</button>
