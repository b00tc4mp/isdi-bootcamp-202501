        ...
        return Workout.insertMany([
            {
                ...
                name: "bench press",
                muscleGroup: "chest",
                feedImage: "https://blog.nasm.org/hubfs/bench-press-form.jpg",
                type: "strength",
                difficulty: "easy",
            ...
            },
            {
                ...
                name: "pull-ups",
                muscleGroup: "back",
                feedImage: "https://media.post.rvohealth.io/wp-content/uploads/2019/09/pull-up-pullup-gym-732x549-thumbnail.jpg",
                type: "cardio",
                difficulty: "easy",
                description: "best back exercise!",
                executionImages: ["url1", "url2"],
    ...
    .then(([benchPress, dips, militaryPress, lateralRaises, walkingLunges, bulgarianSquat, hipThrust, gluteKickacks, bicepsCurl, hammerCurl, pullUps, rowing, tricepsPushdown, tricepsDips]) => {
        return Routine.insertMany([
            ...
            },
            {
                ...
                feedImage: "https://cdn.muscleandstrength.com/sites/default/files/field/feature-wide-image/workout/4-week-leg-lashing-workout-wide.jpg",
                duration: 60,
                status: "accepted",
                frequencySuggestion: "2x per week",
                likes: [masha._id],
