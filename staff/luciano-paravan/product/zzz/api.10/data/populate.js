        ...
        return Promise.all([
            ...
            .then(([diego, luciano, pajaro, eugeni, caruso, aaron]) => {
                return Post.insertMany([
                    { author: diego.id, image: 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExNHAwM2FyeHVmdTlhaXltdHF2NWkwYnprcm5reHY3M2FwbmkwMXE4bSZlcD12MV9naWZzX3NlYXJjaCZjdD1n/dyuc5DfSUg1RGg8P3p/giphy.gif', text: 'Ok!', likes: [caruso.id, aaron.id], createdAt: new Date(2024, 11, 1) },
                    { author: luciano.id, image: 'https://media.giphy.com/media/v1.Y2lkPTc5MGI3NjExdWc2b2lteHdsamxtOHQybTB1ZXEzZnA4dXYwbWQ1MnVmcmU5ZjI2ciZlcD12MV9naWZzX3RyZW5kaW5nJmN0PWc/t3sZxY5zS5B0z5zMIz/giphy.gif', text: 'Yeeeeah!', likes: [eugeni.id], createdAt: new Date(2023, 9, 31) },
