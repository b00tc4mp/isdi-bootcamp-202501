...
export const validate = {
    ...
    username(username, explain = 'username') {
        ...
        if (!constant.USERNAME_REGEX.test(username)) throw new ValidationError(`invalid ${explain} maxLength`)
    },
    ...
    url(url, explain = 'url') { //Si se omite el parametro, se pone por defecto url en explain
