...
console.info('CASE add character')

{
    const characters = ['a', 'b', 'c']
    charactersCopy = []
    characters.forEach(
        (character) => (charactersCopy[charactersCopy.length] = character)
    )
...

{
    ...
    charactersCopy = []
    characters.forEach(
        (character, index) => (charactersCopy[index] = character)
    );
...

{
    ...
    console.assert(mappedCharacters('b') === 'B', 'mappedCharacters[a] is A')
    console.assert(mappedCharacters('c') === 'C', 'mappedCharacters[a] is A')
