...
logic.checkProductExistance = function () {}

logic.addProductToCart = function() {
...
logic.getCheckOutCart = function () {
    var date = new Date()
    var invoice = 'N123456'
...
interface.viewOptions = function() {
    try {
...
interface.chooseOption = function() {
...
interface.askIdProductToCart = function() {
    try {
