export function Landing({ onNavigateToRegister, onNavigateToLogin }) {
    ...
    return <div className="flex flex-col items-center justify-center h-screen gap-4 p-6 rounded-md shadow-md">
        <h1 className="text-4xl">myLook<span className={`text-[var(--fourth-color)]`}>AI</span></h1>
