...
console.info('CASE map all numbers to themselfs multiplied by 2')
...

{
    ...
    const numsBy2PlusIndex = nums.map((x, index, array) => x * 2 + index + array.length)
    ...
    console.assert(numsBy2PlusIndex.length === 4, 'numsBy2PlusIndex.length is 4')
    console.assert(numsBy2PlusIndex[0] === 6, 'numsBy2PlusIndex[0] is 6')
    console.assert(numsBy2PlusIndex[1] === 13, 'numsBy2PlusIndex[1] is 13')
    console.assert(numsBy2PlusIndex[2] === 24, 'numsBy2PlusIndex[2] is 24')
    console.assert(numsBy2PlusIndex[3] === 39, 'numsBy2PlusIndex[3] is 39')
}