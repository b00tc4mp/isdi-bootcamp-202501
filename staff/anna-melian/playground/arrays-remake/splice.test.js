...
console.info('CASE 1: remove 1 element at index 2, and insert trumpet')
...
console.info('CASE 2: remove 2 element at index 1, and insert trumpet and clarinet')

{
    ...
    console.assert(myFish.length === 4, 'myFish.length is 4')
    console.assert(myFish[0] === 'angel', 'myFish[0] is angel')
    console.assert(myFish[1] === 'trumpet', 'myFish[1] is clown')
    console.assert(myFish[2] === 'clarinet', 'myFish[2] is trumpet')
    console.assert(myFish[3] === 'sturgeon', 'myFish[3] is sturgeon')
    console.assert(removed.length === 2, 'removed.length is 1')
    console.assert(removed[0] === 'clown', 'removed[0] is clown')
    console.assert(removed[1] === 'drum', 'removed[1] is drum')
}

console.info('CASE 3: remove 2 elements, strating from index 2')
...
console.info('CASE 4: remove 3 elements, starting from index 1')
...
console.info('CASE 5: remove 1 element from index -2')

{
    ...
    console.assert(removed[0] === 'mandarin', 'removed[1] is mandarin')
}

console.info('CASE 6: remove 1 element at index -2, and insert trumpet')
