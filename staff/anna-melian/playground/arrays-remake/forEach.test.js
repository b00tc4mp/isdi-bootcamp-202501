...

{
    ...
    character.forEach(character => charactersCopy[charactersCopy.length] = character)

    console.assert(character[0] === 'a', 'character[0] is a')
    console.assert(character[1] === 'b', 'character[1] is b')
    console.assert(character[2] === 'c', 'character[2] is c')
    console.assert(character.length === 3, 'character.length is 3')
