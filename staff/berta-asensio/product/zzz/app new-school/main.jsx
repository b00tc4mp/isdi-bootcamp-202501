...
function Login(props) {
    ...
    useEffect(() => {
        ...
        return () => console.debug('Login -> "componentWillUnmount" (useEffect)')
    }, [])

    useEffect(() => {
        console.debug('Login -> "componentWillReceiveProps" (useEffect)')
    }, [mode])
...
function Register(props) {
    ...
    useEffect(() => {
        ...
        return () => console.debug('Register -> "componentWillUnmount" (useEffect)')
    }, [])

    useEffect(() => {
        console.debug('Register -> "componentWillReceiveProps" (useEffect)')
    }, [mode])
