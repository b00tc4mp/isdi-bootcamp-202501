...
describe('deletePost', () => {
    ...
    it('succeeds at deleting post', () => {
        ...
        return Promise.all([
            ...
            .then(post => {
                postId = post._id
                return deletePost(userId.toString(), postId.toString())
            })
            .then(() => Post.findOne({ text: 'testing' }).lean())
    ...
    it('fails on non existing user', () => {
        ...
        return deletePost('67dd9ed19312d9e32d86590c', '67dd9ed19312d9e32d865913')
    ...
    it('fails on non existing post', () => {
        ...
        return User.create({
            ...
            .then(() => {
                return deletePost(userId.toString(), '67dd9ed19312d9e32d865913')
            })
            .catch(error => catchedError = error)
            .finally(() => {
                expect(catchedError).to.be.instanceOf(NotFoundError)
