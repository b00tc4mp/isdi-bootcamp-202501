  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-pink-100'>
      <div className='flex flex-col items-center text-center w-full max-w-lg bg-white p-10 rounded-3xl shadow-lg space-y-8'>
        <img src='../assets/asset_no_border_logo.png' alt='Couple App Logo' className='h-46 mb-4' />
        ...
        <div className='space-y-4 w-full'>
          <button onClick={handleLoginClick} className='w-full py-2 bg-pink-200 rounded-xl text-white font-semibold hover:bg-pink-300'>
            Login
          </button>
          <button onClick={handleRegisterClick} className='w-full py-2 bg-pink-300 rounded-xl text-white font-semibold hover:bg-pink-400'>
            Register
          </button>
        </div>
      </div>
