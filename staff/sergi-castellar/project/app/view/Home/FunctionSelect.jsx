        ...
        <div className="bg-pink-100 flex flex-col items-center justify-center space-y-4">
            ...
            <div className="text-center bg-white p-4 rounded-3xl shadow-lg max-w-md mx-auto">
                <div className="flex justify-center items-center space-x-2">
                    ...
                    <p className="text-xl font-medium text-gray-800">It’s been <span className="font-bold text-gray-900">{daysTogether}</span> days since <span className="font-bold text-gray-900">{partnerName}</span> and you met</p>
                </div>
            </div>
