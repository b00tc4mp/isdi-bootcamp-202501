...
import { retrieveDiaryEntry } from "./retrieveDiaryEntry.js"
import { expect } from 'chai'
import { NotFoundError, AuthorizationError } from 'com/errors.js'

const { MONGO_URL, MONGO_DB } = process.env

describe('retrieveDiaryEntry', () => {
    ...
    it('succeeds at retrieving diary entry', () => {
        return User.create({
            name: 'John Doe',
            email: 'john@doe.com',
            username: 'johndoe',
            ...
            .then(entry => {
                ...
                return retrieveDiaryEntry(userId, entryId)
            })
            .then(entry => {
                expect(entry.text).to.equal('This is a diary entry')
            })
    })
    ...
    it('fails at non-existent couple', () => {
        return User.create({
            ...
            .then(user => {
                userId = user._id.toString()
                return retrieveDiaryEntry(userId, '68078541d746d7c09cd60288')
            })
            .catch(error => {
