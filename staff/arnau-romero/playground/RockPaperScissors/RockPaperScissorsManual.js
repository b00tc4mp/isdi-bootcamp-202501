...
function RockPaperScissorsPlayer1(){ //- El usuario eligira si saca piedra papel o tijera. [u3a]
    ...
    */
    ...
    //[u3a.1]
    player1choice = prompt('Rock(r) Paper(p) or Scissors(s) ? ') //Preguntar piedra papel o tijera [u3a.1]
    player1choice = player1choice.toLowerCase() // Pasarlo a minusculas por si lo pone en mayusculas
    
    //[ru3a.2]
    var reGexChoisePlayer1 = /[rps]/ // Regex para verificar que poner r p o s 
    if(reGexChoisePlayer1.test(player1choice)) return // Si es true salimos de la funcion
    else{
...
function RockPaperScissorsPlayer2() {//- El usuario 2 eligira si saca piedra papel o tijera. [u3b]
    ...
    */
    ...
    //[u3b.1]
    player1choice = prompt('Rock(r) Paper(p) or Scissors(s) ? ') //Preguntar piedra papel o tijera
    player1choice = player1choice.toLowerCase() // Pasarlo a minusculas por si lo pone en mayusculas
