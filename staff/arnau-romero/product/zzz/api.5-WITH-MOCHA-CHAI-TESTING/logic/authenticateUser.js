...
export const authenticateUser = (username, password) => {
    validate.username = (username) // Validamos nombre de usuario usando su método de validación
    validate.password = (password) // Validamos contraseña

    return User.findOne({ username }).lean() // Buscamos usuario en la base de datos por 'username'
