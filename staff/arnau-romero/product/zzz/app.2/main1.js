...
var landing = {
    mount: function () {
        //DIV DE LANDING
        var container = document.createElement('div') //Creo div landing.
        landing.container = container
        document.body.appendChild(container) // Asigno la div landing a body (ahora landing es hijo de body).
        ...
        container.appendChild(logo) //Asigno el LandingLogo al landing (ahora landingLogo es el hijo de landing).
        ...
        container.appendChild(registerAnchor) // Assigno elemento landingRegisterAnchor a landing.
        ...
        container.appendChild(loginAnchor)  // Asigno este elemento a landing (landingLoginAnchor sera hijo de landing)
...
var register = {
    mount: function (){
        var container = document.createElement('div') // Creo div register
        ...
        logo.textContent = 'Logo'
        container.appendChild(logo) // Assigno el elemento registerLogo a register 

        // FORMULARIO REGISTRO
        var form = document.createElement('form'); // Creo el formulario register form
        container.appendChild(form) // Assigno el registerForm al div register (ahora registerForm es hijo de register)
        ...
        container.appendChild(logginAnchor2)
...
var login = {
    mount: function(){
        var container = document.createElement('div') // div para login
       login.container = container
        ...
        container.appendChild(labelInputPassword)

        var anchorRegister = document.createElement('a')
        container.appendChild(anchorRegister)
    ...
    var home = {
        ...
        kiwiPost.src = 'https://www.oliveradatenea.com/wp-content/uploads/2024/01/Calcots-con-Airfryer-1.jpg'
        kiwiPost.style.width = '10%'
        kiwiPost.style.height = '10%'
        ...
        kiwiPost.appendChild(kiwiMojis)
