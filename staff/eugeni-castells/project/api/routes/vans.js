...
const deleteVanByIdHandler_1 = require("../handlers/deleteVanByIdHandler");
const updateVanHandler_1 = require("../handlers/updateVanHandler");
...
exports.vanRouter.delete("/:id", authHandler_1.default, deleteVanByIdHandler_1.deleteVanByIdHandler);
exports.vanRouter.patch("/edit/:id", authHandler_1.default, multerHandler_1.multerHandler, updateVanHandler_1.updateVanHandler);
