...
const getCityCountryFromCoords = (longitude, latitude) => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    if (!response.ok) {
        throw new errors_1.LocationError(`GeoDB API request failed: ${response.statusText}`);
    }
    const data = yield response.json();
    if (!((_a = data === null || data === void 0 ? void 0 : data.data) === null || _a === void 0 ? void 0 : _a.length)) {
        throw new errors_1.LocationError("No location found for the given coordinates");
    }
