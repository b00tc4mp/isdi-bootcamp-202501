...
landing.mount = function () {
    ...
    registerAnchor.style.marginInlineStart = '10px'
...
register.mount = function () {
    ...
    submitButton.style.marginInlineStart = '70px'
...
home.mount = function () {
    ...
    // Imagenes
    var coment = document.createElement('h4')
    ...
    news1.style.width = '60%'
    // news1.style.marginBlockEnd = '20px'
    news1.style.border = '2px solid'
    form.appendChild(news1)
    ...
    news2.style.width = '60%'
    news2.style.marginBlockEnd = '20px'
    news2.style.border = '2px solid'
    form.appendChild(news2)
    ...
    news3.style.width = '60%'
    news3.style.marginBlockEnd = '20px'
    news3.style.border = '2px solid'
    form.appendChild(news3)
