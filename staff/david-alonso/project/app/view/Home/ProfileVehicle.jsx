    ...
    return (
        <div className="min-h-screen flex flex-col">
            ...
            <section className=" pt-10 p-5 ">
                ...
                <Link to={`/vehicle/${id}/maintenance`} className="bg-white text-black p-2 rounded-md w-[80%] text-center mx-auto">+ AÑADIR SERVICIO</Link>
